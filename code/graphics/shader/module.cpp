...
Graphics::Shader_module::Shader_module(Shader_binary const& _binary) {
    ...
    Unique_handle::operator=({shader_module, [](Handle _shader_module) { vkDestroyShaderModule(*logical_device, _shader_module, nullptr); }});
}
